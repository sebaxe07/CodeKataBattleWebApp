...
SECRET_KEY = 'django-insecure-d&zks9671a+f%^3#h2isr+#&rqb$jje3w1t2-9xpk5=6a4i3xx'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['localhost', 'codekatabattle.site' ]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://codekatabattle.site",
    "https://codekatabattle.site",
]

ROOT_URLCONF = 'backend.urls'


DOMAIN = 'codekatabattle.site'
DJOSER = {
